...
/**
 * Groq LLM API wrapper stub for Public UI Demo Branch
 * NO REAL API CALLS - FOR DEMO ONLY
 */
export async function groqChat(
  ...
  return `[Demo Mode] This is a UI-only demo branch. Real AI generation is disabled.\n\nPrompt: ${prompt.substring(0, 100)}...`
}

/**
 * Groq health check ping stub for Public UI Demo Branch
 * Always returns false (not configured in demo)
 */
export async function groqPing(): Promise<boolean> {
  // Demo mode: always return false (not configured)
  return false
}
